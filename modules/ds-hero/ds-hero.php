	...
	'style'   => array(
		...
		'sections' => array(
			...
			'banner_nobg' => array(
				...
				'fields' => array(
					'nobg_color'   => array( 'type' => 'color', 'connections' => array( 'color' ), 'label' => __( 'Background Colour', 'ds-toolkit' ), 'default' => '', 'show_reset' => true, 'help' => __( 'Blank = the site default from Theme Setting (General > Page Banner Background, No Image). Set a colour to override it for this page.', 'ds-toolkit' ), 'preview' => array( 'type' => 'css', 'selector' => '.ds-banner--no-bg', 'property' => 'background-color' ) ),
